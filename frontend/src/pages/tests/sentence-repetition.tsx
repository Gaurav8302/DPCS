...
export default function SentenceRepetition() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(`${(process.env.NEXT_PUBLIC_API_URL || 'https://dpcs.onrender.com')}/scoring/sentence-repetition`, {
        method: 'POST',
      ...
      if (!response.ok) {
        throw new Error('Failed to submit sentence repetition')
      }
